...
data_ip="https://raw.githubusercontent.com/Ezqlusia1/install/main/ip"
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      ${GREEN}TELEGRAM${NC} t.me/Ezqlusia"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit 0
  fi
}
checking_sc
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e " WELCOME Ezqlusia AUTOSCRIPT PREMIUM${YELLOW}(${NC}${green}Stable Edition${NC}${YELLOW})${NC}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Ezqlusia1/install/main/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/Ezqlusia1/install/main/ip"
# USERNAME
rm -f /usr/bin/user
...
TIMES="10"
CHATID="392836663"
KEY="7389576417:AAHwzanb2ANk8FeycKSaM7mB7e9iBtY_XZw"
...
<code>────────────────────</code>
<b> Ezqlusia VPN STORE SCRIPT  </b>
<code>────────────────────</code>
<i>Automatic Notifications From Github</i>
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"t.me/Ezqlusia"}]]}' 
...
wget -q https://raw.githubusercontent.com/Ezqlusia1/install/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
...
echo "------------------------------------------------------------"
echo ""
echo "===============-[ SCRIPT BY Ezqlusia ]-==============="
echo -e ""
echo ""
echo "" | tee -a log-install.txt
echo "ThanksYou For Using Script Ezqlusia"
echo ""
